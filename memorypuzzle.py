...
def main():
  ...
  mousex = 0 # used to store the x coordinate of the mouse event
  mousey = 0 # used to store the y coordinate of the mouse event
...
def drawIcon(shape, color, boxx, boxy):
  ...
  if shape == DONUT:
    ...
    pygame.draw.rect(
      DISPLAYSURF, color, (left + quarter, top + quarter, BOXSIZE - half, BOXSIZE - half))
  elif shape == DIAMOND:
    ...
    for i in range(0, BOXSIZE, 4):
      ...
      pygame.draw.line(
        DISPLAYSURF, color, (left + i, top + BOXSIZE - 1), (left + BOXSIZE -1, top + i))
  elif shape == OVAL:
...
def gameWonAnimation(board):
  ...
  coveredBoxes = generateRevealedBoxesData(board)
  color1 = LIGHTBGCOLOR
  color2 = BGCOLOR
